...
/**
 * This project is a count down timer that can be used to count down multiple
 * things at once as well as add time and take time away. It has many functions
 * such as adding timers together and comparing them.
 *
...
public class CountDownTimer {
	...
	/**
	 * This is the default constructor it initializes all the time values to zero.
	 */
	...
	/**
	 * This is used to initialize a timer with a specified number of hours, minutes
	 * and seconds.
	 * 
	 * @param hours
	 *            This is the number of hours the timer will have
	 * @param minutes
	 *            This is the number of minutes the timer will have
	 * @param seconds
	 *            This is the number of seconds the timer will have
	 */
	...
	/**
	 * This is used to initialize a timer with a specified number of minutes and
	 * seconds.
	 * 
	 * @param minutes
	 *            This is the number of minutes the timer will have
	...
	/**
	 * This is used to initialize a timer with the same values as another timer.
	 * 
	 * @param other
	 *            This is another count down timer that you would like to make a
	 *            copy of.
	 */
	 ...
	 * 
	 * @param startTime
	 *            This is the string that specifies the time you wish to set the
	 *            timer equal to.
	 */
	...
	/**
	 * This is used to check if two timers are equal to each other
	 * 
	 * @param other
	 *            This is the timer that you want to compare the current timer equal
	 *            to.
	 */
	public boolean equals(Object other) {
		...
		if (this.hours == compare.getHours() && this.minutes == compare.getMinutes()
	 ...
	 * 
	 * @param t1
	 *            This is one count down timer that you want to compare
	 * @param t2
	 *            This is the other count down timer that you want to compare
	 */
	 ...
	 * 
	 * @param other
	 *            This is the timer that you want to compare the current timer to.
	 */
